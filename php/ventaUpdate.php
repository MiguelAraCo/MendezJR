...
if ($con->isConnectionUp()){
  ...
  $queryString = "INSERT INTO ".$constants->ventasTableName." (id, cliente, factura, tipo_pago, banco, cliente_envio, cliente_recive, cantidad_recivida, total, sucursal, estado) VALUES (NULL,'". $cliente ."', '". $factura ."', '". $tipo_pago ."', '". $banco ."', '". $envio ."', '". $recive ."', '". $cantidad ."', '". $total ."', '".$constants->sucursalActual."', '".$constants->estadoActivo."')";
